            ...
            <div className='mt-10'>
                <form onSubmit={handleAddService} >
                    ...
                    <div className='flex justify-center'>
                        <textarea className='block p-5 text-center' name="serviceName" id="" cols="70" rows="1" placeholder='Name your service'></textarea>
                    </div>

                    <label className='block text-2xl my-2' htmlFor="">Add a photo</label>
                    <div className='flex justify-center'> <textarea className='block p-5 text-center' name="servicePhotoUrl" id="" cols="70" rows="1" placeholder='Photo URL'></textarea></div>
                    ...
                    <div className='flex justify-center mt-5'>
                        <div className='pr-5'>
                            ...
                            <textarea className=' px-20 py-5 text-center' name="price" id="" cols="10" rows="1" placeholder='Price in $'></textarea>
                        </div>
                        <div className=''>
                            <label className='block text-lg mb-2' htmlFor="">Rating</label>
                            <textarea className=' px-20 py-5 text-center' name="rating" id="" cols="10" rows="1" placeholder='Rating'></textarea>
                        </div>
                    </div>
