      ...
      <div className="  blog lg:p-5">
        <div className=" w-11/12 mx-auto mb-10 p-10 shadow-xl shadow-xl">
          ...
          <p className="text-justify">
            ...
            <br />
            <br />
            <span className="text-rose-500 font-semibold">How JWT works :</span>
            <br />
        ...
        <div className="w-11/12 mx-auto mt-10 p-10 shadow-lg shadow-xl">
          ...
          <p className="text-justify">
            ...
            outside the browser with the help of NodeJS. <br /> <br />
            3. It is basically used on the client-side. It is mostly used on the
            server-side. <br /> <br />
            ...
            safari and Spidermonkey in Firefox. <br /> <br />
            ...
            <br /> <br />
            7. Some of the javascript frameworks are RamdaJS, TypedJS, etc. Some
            of the Nodejs modules are Lodash, express etc. These modules are to
        ...
        <div className="w-11/12 mx-auto p-10 shadow-lg  shadow-xl">
          ...
          <p className=" text-justify ">
            1. How NodeJS handle multiple client requests? NodeJS receives
